import type { GovcToolDef } from './types';
import { bool, CLUSTER, DS, FOLDER, HOST, NET, num, POOL, str, strEnum, VM } from './types';

// ---------------------------------------------------------------------------
// GOVC_TOOL_DEFS – typed MCP tools for agent-required commands
// ---------------------------------------------------------------------------
